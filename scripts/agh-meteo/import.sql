...
CREATE TABLE meteo_observations (
    ...
    th_hour_min NUMERIC(7,2),
    th_hour_avg NUMERIC(7,2),
    th_hour_max NUMERIC(7,2),
    ...
    vh_hour_avg NUMERIC(7,2),
    vh_hour_max NUMERIC(7,2),
    vh_hour_min NUMERIC(7,2),
    vs_hour_avg NUMERIC(7,2),
    vs_hour_max NUMERIC(7,2),
    vs_hour_min NUMERIC(7,2),
    vr_hour_avg NUMERIC(7,2),
    vr_hour_max NUMERIC(7,2),
    vr_hour_min NUMERIC(7,2),
    odew_hour_avg NUMERIC(7,2),
    odew_hour_max NUMERIC(7,2),
    odew_hour_min NUMERIC(7,2),
    owindchill_hour_avg NUMERIC(7,2),
    owindchill_hour_max NUMERIC(7,2),
    owindchill_hour_min NUMERIC(7,2),
    oheatindex_hour_avg NUMERIC(7,2),
    oheatindex_hour_max NUMERIC(7,2),
    oheatindex_hour_min NUMERIC(7,2),
...
\copy meteo_observations (time,sn_hour_avg,sn_hour_max,sn_hour_min,sm_hour_avg,sm_hour_max,sm_hour_min,sx_hour_avg,sx_hour_max,sx_hour_min,dn_hour_avg,dn_hour_max,dn_hour_min,dm_hour_avg,dm_hour_max,dm_hour_min,dx_hour_avg,dx_hour_max,dx_hour_min,ta_hour_avg,ta_hour_max,ta_hour_min,pa_hour_avg,pa_hour_max,pa_hour_min,tp_hour_avg,tp_hour_max,tp_hour_min,ua_hour_avg,ua_hour_max,ua_hour_min,rc_hour_avg,rc_hour_max,rc_hour_min,rd_hour_avg,rd_hour_max,rd_hour_min,ri_hour_avg,ri_hour_max,ri_hour_min,rp_hour_avg,rp_hour_max,rp_hour_min,hc_hour_avg,hc_hour_max,hc_hour_min,hd_hour_avg,hd_hour_max,hd_hour_min,hi_hour_avg,hi_hour_max,hi_hour_min,hp_hour_avg,hp_hour_max,hp_hour_min,odew_hour_avg,odew_hour_max,odew_hour_min,barosealevel_hour_avg,barosealevel_hour_max,barosealevel_hour_min,owindchill_hour_avg,owindchill_hour_max,owindchill_hour_min,oheatindex_hour_avg,oheatindex_hour_max,oheatindex_hour_min) FROM 'agh_meteo_2017.csv' WITH HEADER DELIMITER ',' CSV;
-- Na koncu pliku z http://meteo.ftj.agh.edu.pl/meteo/archiwalneDaneMeteo jest dodatkowy przecinek, ktory trzeba recznie usunac!

select time, sm_hour_avg from meteo_observations limit 10;
