...
cp plots/training-history/history__neural_network__hidden=20-10-5-3__activation=relu__epochs=100__min_delta=1e-04__patience_ratio=0.25__batch_size=32__learning_rate=0.001__epsilon=1e-05__l2=0.001__split_id=2@gios_bujaka@2019-05-31_07:53:10@dataset_2__test__season_and_year__.png  $PLOT_DIR/training_history/under_fit.png
