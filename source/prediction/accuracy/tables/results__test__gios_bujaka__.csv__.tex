...
\begin{tabular}{lllrrrrrrrrrrr}
 ...
 \midrule
\makecell[tl]{\textbf{SVR}\\ \textit{gamma} = $2^{-12}$ \\ \textit{epsilon} = $2^{-1}$ \\ \textit{cost} = $2^{6}$} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{EADAFF}{seasonal} &   2 & 25.10 &  & 36.43 &  & 103.59 &  & 0.46 &  & 0.19 &  \\ 
  \makecell[tl]{\textbf{neural network}\\ \textit{hidden} = $(10)$ \\ \textit{learning rate} = $10^{-1}$ \\ \textit{epsilon} = $10^{-8}$ \\ \textit{L2} = $10^{-1}$} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{FFFFFF}{all} &  52 & 25.95 & 0.66 & 36.61 & 0.34 & 115.94 & 10.36 & 0.45 & 0.01 & 0.18 & 0.02 \\ 
  \makecell[tl]{\textbf{regression}} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{FFFFFF}{all} &   1 & 26.43 &  & 36.46 &  & 127.45 &  & 0.44 &  & 0.19 &  \\ 
  \makecell[tl]{\textbf{SVR}\\ \textit{gamma} = $2^{-6}$ \\ \textit{epsilon} = $2^{-3}$ \\ \textit{cost} = $2^{8}$} & \cellcolor[HTML]{88FF99}{spring} & \cellcolor[HTML]{FFFFFF}{all} &   1 & 8.26 &  & 12.27 &  & 50.95 &  & 0.71 &  & 0.49 &  \\ 
