...
\begin{tabular}{lllrrrrrrrrr}
 ...
 \midrule
\makecell[tl]{\textbf{SVR}\\ \textit{gamma} = $2^{-12}$ \\ \textit{epsilon} = $2^{-1}$ \\ \textit{cost} = $2^{2}$} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{FFFFFF}{all} &   1 & 22.27 &  & 31.62 &  & 76.00 &  & 0.19 &  \\ 
  \makecell[tl]{\textbf{regression}} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{FFFFFF}{all} &   1 & 22.85 &  & 30.57 &  & 99.50 &  & 0.24 &  \\ 
  \makecell[tl]{\textbf{neural network}\\ \textit{hidden} = $(10, 5, 3)$ \\ \textit{learning rate} = $10^{-3}$ \\ \textit{epsilon} = $10^{-4}$ \\ \textit{L2} = $10^{-1}$} & \cellcolor[HTML]{99FFFF}{winter} & \cellcolor[HTML]{FFFFFF}{all} &  25 & 22.89 & 0.61 & 31.19 & 1.36 & 94.54 & 3.87 & 0.21 & 0.08 \\ 
  \makecell[tl]{\textbf{SVR}\\ \textit{gamma} = $2^{-6}$ \\ \textit{epsilon} = $2^{-3}$ \\ \textit{cost} = $2^{-2}$} & \cellcolor[HTML]{88FF99}{spring} & \cellcolor[HTML]{FFFFFF}{all} &   1 & 8.07 &  & 12.00 &  & 63.93 &  & 0.45 &  \\ 
  \makecell[tl]{\textbf{regression}} & \cellcolor[HTML]{88FF99}{spring} & \cellcolor[HTML]{EADAFF}{seasonal} &   1 & 8.82 &  & 12.54 &  & 76.61 &  & 0.40 &  \\ 
